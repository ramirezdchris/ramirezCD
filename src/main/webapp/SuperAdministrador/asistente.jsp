    ...
    <body>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="model-body" style="padding: 1rem;">
                        <form action="asistente?action=add" method="POST">                                
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="input-group">                                      
                                        <span class="input-group-text">Nombre Asistente</span>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="input-group">                                      
                                        <span class="input-group-text">Apellido Asistente</span>
        ...
        <div class="row" style="margin-right: 0px;">
            ...
            <div class="col-md-9" style="margin-right: 0; padding-right: 0px;">
                <div class="row"  style="margin-right: 0px;">
                    <div class="col-md-5">
                        <h1>Mantenimieto Asistente</h1><br>
                        <input type="submit" value="Agregar Nuevo Asistente" name="add" class="btn btn-default btn-sm " style="float: left; height: 60px; border-radius: 15px; background-color: #5dc1b9;" data-toggle="modal" data-target="#myModal"/><br><br>
                    </div>
                    <div class="col-md-4">
